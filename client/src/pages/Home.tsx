...
export default function Home() {
  ...
  const go = (path: string) => {
    setIsMenuOpen(false);
    // đợi drawer đóng nhẹ rồi điều hướng (mượt + tránh giật)
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-x-hidden">
        ...
        <footer
          id="footer-tabs"
          className="py-12 px-4 max-w-2xl mx-auto border-t border-primary/10"
        >
              ...
              <TabsContent value="about">
                <Card className="game-border bg-white/50 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    <h3 className="font-display font-bold text-xl text-primary mb-4 text-center">
                      About Hà Văn Huấn
                    </h3>
                    <p className="text-muted-foreground leading-relaxed text-center">
                      Chào mừng bạn đến với trang bio cá nhân của tôi! Tôi là một
                      lập trình viên Full Stack với đam mê tạo ra những trải
                      nghiệm web độc đáo và sáng tạo.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
                  ...
                  <CardContent className="pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <a
                        ...
                        className="flex items-center gap-3 p-3 rounded-2xl bg-blue-50 dark:bg-blue-900/20 hover:scale-105 transition-transform"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3 rounded-2xl bg-indigo-50 dark:bg-indigo-900/20 hover:scale-105 transition-transform"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3 rounded-2xl bg-sky-50 dark:bg-sky-900/20 hover:scale-105 transition-transform"
                      >
                      ...
                      <a
                        ...
                        className="flex items-center gap-3 p-3 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 hover:scale-105 transition-transform"
                      >
